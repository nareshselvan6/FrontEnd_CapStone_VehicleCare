...
const token=localStorage.getItem("jwt")
  ...
  <div className="tsimagediv d-flex align-items-center gap-1 "><img src="images\TS.jpg" className="tsimage " /> CarCare </div>
    ...
    <div className="collapse navbar-collapse" id="navbarResponsive">
      ...
      <li className="nav-item"><Link className="nav-link " to="/">Home</Link></li>
       ...
       {token? <li className="nav-item"><Link className="nav-link " to="/allservices">All Services</Link></li>:null}
       {token?  <li className="nav-item"><Link className="nav-link" to="/pastservice">PastService</Link></li>:null}
